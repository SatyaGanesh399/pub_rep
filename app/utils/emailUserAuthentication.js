...
const emailUserAuthentication = async ({ toUser, token }) => {
  return new Promise((res, rej) => {
    ...
    const message = {
      from: '"Pro Garten" <' + process.env.MAIL_USERNAME + "",
      to: toUser.email,

      subject: "Pro Garten - Activate Account",
      html: `
            <head>
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
        <tr>
          <td style="color: #00adb5; font-family: Arial, sans-serif;">
            <h3 style="font-size: 24px; margin: 0; margin-bottom:6px; text-align:center; font-family: Montserrat, sans-serif;">Hey ${toUser.name}</h3>
            <h3 style="font-size: 24px; margin: 0; text-align:center; "color: #00adb5;  font-family: Montserrat, sans-serif;">Activate your Pro Garten account ... !</h3>
          </td>
        </tr>
        <tr>
          <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
          <a href="${process.env.DOMAIN}/confirmation/${token}" style=" border: none;
...
module.exports = emailUserAuthentication
