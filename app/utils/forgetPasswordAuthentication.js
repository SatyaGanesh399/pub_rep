...
const forgetPasswordAuthentication = async ({ toUser, token }) => {
  return new Promise((res, rej) => {
    ...
    const message = {
      ...
      subject: "Pro Garten - Forget Password",
      html: `
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
            <tr>
              <td style="color: #00adb5; font-family: Arial, sans-serif;">
                ...
                <h3 style="font-size: 24px; margin: 0; text-align:center; font-family: Montserrat, sans-serif;">Change your password...</h3>
              </td>
            </tr>
            <tr>
              <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
              <a href="${process.env.DOMAIN}/forgetredirect/${token}" style=" border: none;
...
module.exports = forgetPasswordAuthentication
