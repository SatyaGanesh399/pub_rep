...
type ModalUploadClipartProps = {
  className?: string;
};

const ModalUploadClipart = ({ className }: ModalUploadClipartProps) => {
  return (
    <Svg
      id="upload-modal-clipart"
      title="upload-modal-clipart"
      className={className}
...
export default ModalUploadClipart;
