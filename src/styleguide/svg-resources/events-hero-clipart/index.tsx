...
type EventsHeroClipartProps = {
  className?: string;
};

const EventsHeroClipart = ({ className }: EventsHeroClipartProps) => (
  <Svg
    id="events-hero-clipart"
    title="events-hero-clipart"
    viewBoxWidth={965.64}
    viewBoxHeight={800.81}
    className={className}
  >
    <defs>
      <linearGradient
    ...
    <circle cx="440.87" cy="288.03" r="5.7" fill="#f58862" />
    <circle cx="455.12" cy="288.03" r="5.7" fill="#f58862" />
    <circle cx="745.64" cy="451.33" r="5.7" fill="#f58862" />
    <circle cx="748.49" cy="444.69" r="5.7" fill="#f58862" />
    <circle cx="751.34" cy="438.99" r="5.7" fill="#f58862" />
    <circle cx="645" cy="203.53" r="5.7" fill="#f58862" />
    <circle cx="659.24" cy="203.53" r="5.7" fill="#f58862" />
    <circle cx="673.49" cy="203.53" r="5.7" fill="#f58862" />
    <circle cx="687.73" cy="203.53" r="5.7" fill="#f58862" />
    <circle cx="645" cy="380.12" r="5.7" fill="#f58862" />
    <circle cx="659.24" cy="380.12" r="5.7" fill="#f58862" />
    <circle cx="673.49" cy="380.12" r="5.7" fill="#f58862" />
    <circle cx="687.73" cy="380.12" r="5.7" fill="#f58862" />
...
export default EventsHeroClipart;
