...
type BlogInstaClipartProps = {
  className?: string;
};

const BlogInstaClipart = ({ className }: BlogInstaClipartProps) => (
  <Svg
  ...
  >
    <g>
      ...
      <g>
        <path
          fill="#EF7E5C"
          d="M32.76,15.54c-0.95,0-1.72,0.77-1.72,1.72c0,0.95,0.77,1.72,1.72,1.72c0.95,0,1.72-0.77,1.72-1.72
			C34.48,16.31,33.71,15.54,32.76,15.54z"
        />
        <path
          fill="#EF7E5C"
          d="M25.12,17.75c-3.98,0-7.22,3.24-7.22,7.22c0,3.98,3.24,7.22,7.22,7.22c3.98,0,7.22-3.24,7.22-7.22
        ...
        <path
          fill="#EF7E5C"
          d="M30.85,39.62h-11.7c-4.85,0-8.8-3.95-8.8-8.8v-11.7c0-4.86,3.95-8.8,8.8-8.8h11.7
...
export default BlogInstaClipart;
